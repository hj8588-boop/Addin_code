...
$backup = Join-Path $dir 'backup_civil3d_dwg_to_revit_outer_top_single_run_autoplace.dyn'
$target = Join-Path $dir 'civil3d_dwg_outer_top_edge_proxy_selectable.dyn'
