...
def create_helper_directshape_from_planar_face(face, transform=None):
    ...
    try:
        direct_shape.SetShape([helper_solid])
    except Exception:
        return None, []

    return direct_shape, curve_loops
...
def main():
    ...
    try:
        if (
            ...
            helper_directshape, helper_curve_loops = create_helper_directshape_from_planar_face(
                selected_face,
                selected_face_transform,
            )
