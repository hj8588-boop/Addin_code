...
def create_helper_directshape_from_planar_face(
    ...
    p1 = plane_origin + (axis_x.Multiply(min_x)) + (axis_y.Multiply(min_y))
    p2 = plane_origin + (axis_x.Multiply(max_x)) + (axis_y.Multiply(min_y))
    p3 = plane_origin + (axis_x.Multiply(max_x)) + (axis_y.Multiply(max_y))
    p4 = plane_origin + (axis_x.Multiply(min_x)) + (axis_y.Multiply(max_y))
